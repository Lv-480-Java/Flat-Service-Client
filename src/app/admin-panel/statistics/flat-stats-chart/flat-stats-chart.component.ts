...
@Component({
  selector: 'app-flat-stats-chart',
  templateUrl: './flat-stats-chart.component.html',
  styleUrls: ['./flat-stats-chart.component.scss']
})
export class FlatStatsChartComponent implements OnInit {
